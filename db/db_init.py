...
c.executemany(
    "INSERT INTO subcategories (name, category_id) VALUES (?,?)", subcategories)
...
c.executemany(
    "INSERT INTO items (title, description, price, image, category_id, subcategory_id) VALUES (?,?,?,?,?,?)", items)
